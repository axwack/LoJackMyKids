 ...
 * <p/>
 * TODO: ************ IMPORTANT SETUP NOTES: ************ In order for Google+
 * sign in to work with your app, you must first go to:
...
public class LoginActivity extends PlusBaseActivity implements
	...
	protected void onActivityResult(int requestCode, int responseCode,
		...
		Log.i(MainActivity.DEBUGTAG, "in on Activity");
	...
	private void checkForSharedPrefs() {
		...
		Log.i(MainActivity.DEBUGTAG,
				"[LOGIN ACTIVITY] Current Prefs: The password setting is "
						+ password_set);
		Log.i(MainActivity.DEBUGTAG,
				"[LOGIN ACTIVITY] Current Prefs: Is this device a child? "
						+ device_is_child);
		Log.i(MainActivity.DEBUGTAG,
				"[LOGIN ACTIVITY] Saved Password in Prefs: " + password); // TODO:
																			// Need
																			// to
																			// Encrypt
	}
